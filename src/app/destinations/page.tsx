            ...
            <section className="py-16 bg-background">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-foreground mt-2 mb-4 leading-tight">
                    ...
                    {destinations.length === 0 ? (
                        <div className="text-center py-20">
                            ...
                            <h2 className="text-2xl font-bold text-foreground mb-2">No destinations yet</h2>
                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            {destinations.map((dest: any) => (
                                <div
                                    key={dest._id}
                                    className="group bg-card rounded-2xl overflow-hidden shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-300"
                                >
                                    <div className="relative h-60 overflow-hidden">
                                        ...
                                        />
                                        {dest.featured && (
                                            <span className="absolute top-3 left-3 bg-foreground text-background text-xs font-bold px-3 py-1.5 rounded-full">
                                                Featured
                                            </span>
                                        )}
                                    ...
                                    <div className="p-5">
                                        ...
                                        <Link
                                            ...
                                            className="inline-flex items-center gap-2 px-5 py-2.5 bg-foreground text-background text-sm font-semibold rounded-full hover:bg-foreground/85 transition-all group/btn"
                                        >
                                            View packages
